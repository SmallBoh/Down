...
public class ThreadDownActivity extends Activity implements OnClickListener {
	...
	private List<DownThreadEntity> getList() {
		...
		// list.add(new
		// DownThreadEntity("http://filelx.liqucn.com/upload/2015/qipai/KuaiLeZhaNiMei_liqu001.ptada"));
		// list.add(new
		// DownThreadEntity("http://filelx.liqucn.com/upload/2015/qipai/qyw_1.4.3_mm_0205_300008286790_2200126314.ptada"));
		// list.add(new
		// DownThreadEntity("http://filelx.liqucn.com/upload/2014/dongzuo/39_0112_xiongda_liqu_3_cm4he1_hPqdsI_300008139114_2200126314_signed.ptada"));
		//
		// list.add(new
		// DownThreadEntity("http://filelx.liqucn.com/upload/2012/qipai/DDZ_V1.8.4_29015_VC40_8139_001.ptada"));
		return list;
	}
	...
	// case R.id.thread_item_stopbutton: exit(); break; } } private final class
	// UIHandler extends Handler {
